...
The range of bill length is `r range(pull(penguins,bill_length_mm),na.rm = TRUE)`; the range of bill depth is `r range(pull(penguins,bill_depth_mm),na.rm = TRUE)`; the range of flipper length is `r range(pull(penguins,flipper_length_mm),na.rm = TRUE)`; the range of year is `r range(pull(penguins, year), na.rm = TRUE)`; the levels of species are `r levels(pull(penguins, species))`; the levels of island are `r levels(pull(penguins, island))`; the levels of sex are `r levels(pull(penguins, sex))`.  
