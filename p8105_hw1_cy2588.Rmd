...
The range of bill length is `r range(pull(penguins,bill_length_mm),na.rm = TRUE)`;  
the range of bill depth is `r range(pull(penguins,bill_depth_mm),na.rm = TRUE)`;  
the range of flipper length is `r range(pull(penguins,flipper_length_mm),na.rm = TRUE)`;  
the range of body mass is `r range(pull(penguins,body_mass_g),na.rm = TRUE)`;  
